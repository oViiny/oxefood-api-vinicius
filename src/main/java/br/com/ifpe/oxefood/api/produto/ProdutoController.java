...
public class ProdutoController {
    ...
    @Operation(
        ...
        description = "Exemplo de descrição de um endpoint responsável por atualizar um produto(por id) no sistema."
    )
    @PutMapping("/{id}")
    ...
    @Operation(
        ...
        description = "Exemplo de descrição de um endpoint responsável por istar todos os produtos no sistema."
    )
    @GetMapping
    ...
    @Operation(
        summary = "Serviço responsável por obter um produto(por id) no sistema.",
        description = "Exemplo de descrição de um endpoint responsável por obter um produto(por id) no sistema."
    )
    @GetMapping("/{id}")
